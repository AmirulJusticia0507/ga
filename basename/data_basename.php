...
<section class="content-header">
  <h1>List Of Susi Air Bases
    <small>Please update Base Name regularly</small>
  </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-sm-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">List Of Bases</h3> 
          <div class="box-tools pull-left"><br>
            <a href="#" class="btn btn-success" data-toggle="modal" data-target="#tambahbasename"><i class="fa fa-map-marker"></i> Tambah Basename</a>
          </div>
        </div>
        <div class="box-body">
            ...
            <table id="datatable" class="display table table-bordered table-striped table-hover hover table-striped" style="width:100%">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td nowrap><?php echo $row['keteranganbase'];?></td>
                    <td>
                      ...
                      <a href="#" class="btn btn-primary btn-flat btn-xs" data-toggle="modal" data-target="#updatebasename<?php echo $no; ?>"><i class="fa fa-pencil"></i> Edit</a>
                      <a href="#" class="btn btn-danger btn-flat btn-xs" data-toggle="modal" data-target="#deletebasename<?php echo $no; ?>"><i class="fa fa-trash"></i> Delete</a>                      
                      
                      <!-- modal delete -->
                      <div class="example-modal">
                        <div id="deletebasename<?php echo $no; ?>" class="modal fade" role="dialog" style="display:none;">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h3 class="modal-title">Konfirmasi Delete Data Basename</h3>
                              </div>
                              <div class="modal-body">
                                <h4 align="center" >Apakah anda yakin ingin menghapus base id <?php echo $row['base_id'];?><strong><span class="grt"></span></strong> ?</h4>
                              </div>
                              <div class="modal-footer">
                                <button id="nodelete" type="button" class="btn btn-danger pull-left" data-dismiss="modal">Cancel</button>
                                <a href="../basename/function_basename.php?act=deletebasename&base_id=<?php echo $row['base_id']; ?>" class="btn btn-primary">Delete</a>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <!-- modal update user -->
                      <div class="example-modal">
                        <div id="updatebasename<?php echo $no; ?>" class="modal fade" role="dialog" style="display:none;">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h3 class="modal-title">Edit Data Basename</h3>
                              </div>
                              <div class="modal-body">
                                <form action="../basename/function_basename.php?act=updatebasename" method="post" role="form" enctype="multipart/form-data">
                                  <?php
                                  $base_id = $row['base_id'];
                                  $query = "SELECT 
                                  *
                                  FROM base
                                --   left join department on requests.base_id = department.department_id
        ...
        <!-- modal insert -->
        <div class="example-modal">
          <div id="tambahbasename" class="modal fade" role="dialog" style="display:none;">
            <div class="modal-dialog"> 
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  <h3 class="modal-title">Add New Base</h3>
                </div>
                <div class="modal-body">
                  <form action="../basename/function_basename.php?act=tambahbasename" method="post" role="form" enctype="multipart/form-data">
                    <!-- <div class="form-group">
                      <div class="row">
                      <label class="col-sm-3 control-label text-right">Id User <span class="text-red">*</span></label>         
                    ...
                    <div class="form-group">
                      <div class="row">
                      <label class="col-sm-3 control-label text-right">Nama Base: <span class="text-red">*</span></label>
                      <div class="col-sm-8"><input type="text" class="form-control" name="basename" placeholder="Nama Request..." value=""></div>
                      </div>
                    </div>
                    <!-- <div class="form-group">
                      <div class="row">
                    ...
                    <div class="form-group">
                      <div class="row">
                      <label class="col-sm-3 control-label text-right">Keterangan Base: <span class="text-red">*</span></label>
                      <div class="col-sm-8"><input type="text" class="form-control" name="keteranganbase" placeholder="Keterangan Base ..." value=""></div>
                      </div>
                    </div>
                    <!-- <div class="form-group">
                      <div class="row">
